...
@implementation AIChatContentAssistantCell
...
-(void)setCellDataByCellVo:(BaseTableCellVo *) baseTableCellVo{
    NSString *markdownString = [NSString stringWithFormat:@"AI助手:%@",[baseTableCellVo.cellDataDic objectForKey:@"lbl1"]];
